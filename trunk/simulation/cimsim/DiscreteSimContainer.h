#ifndef SIM_CS_DISCRETE_CONTAINER_H
#define SIM_CS_DISCRETE_CONTAINER_H
...
class DiscreteSimContainer
{
public:
  DiscreteSimContainer( const input::Container * container, const input::Biology * bio, output::ContainerPopData * containerPopData = NULL );
  ~DiscreteSimContainer(void);
