...
namespace gui {
  ...
  public ref class ScheduleControl : public System::Windows::Forms::UserControl, INotifyPropertyChanged
	{
	public:
    ScheduleControl( BindingSource ^ locationBinding, System::String ^ scheduleBindingSite );
  ...
  private:
    ...
    System::Void MonthIndexToMonthString( System::Object ^ sender, ConvertEventArgs ^ cea );

  private:
    BindingSource ^ LocationBinding_;
    String ^ ScheduleBindingSite_;
    Schedule ^ CurrentSchedule_;
    BindingSource ^ SingleScheduleBinding_;
    BindingSource ^ WeeklyScheduleBinding_;
    BindingSource ^ MonthlyScheduleBinding_;
    BindingSource ^ YearlyScheduleBinding_;
    BindingSource ^ PeriodicScheduleBinding_;
...
#pragma region Windows Form Designer generated code
      ...
      this->tabSchedule->Location = System::Drawing::Point(0, 0);
      this->tabSchedule->Multiline = true;
      this->tabSchedule->Name = L"tabSchedule";
      this->tabSchedule->SelectedIndex = 0;
      this->tabSchedule->Size = System::Drawing::Size(490, 217);
      this->tabSchedule->TabIndex = 1;
      this->tabSchedule->SelectedIndexChanged += gcnew System::EventHandler(this, &ScheduleControl::OnSelectedIndexChanged);
      // 
      // tabPageSingle
      // 
      ...
      this->tabPageSingle->Size = System::Drawing::Size(482, 189);
      ...
      this->tabPageWeekly->Size = System::Drawing::Size(482, 189);
      ...
      this->tabPageMonthly->Size = System::Drawing::Size(482, 189);
      ...
      this->tabPageYearly->Size = System::Drawing::Size(482, 189);
      ...
      this->tabPagePeriodic->Size = System::Drawing::Size(482, 189);
      ...
      this->Size = System::Drawing::Size(493, 220);
