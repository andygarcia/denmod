...
namespace gui {
	...
	public ref class RunDensimForm : public System::Windows::Forms::Form
	{
  // Constructors
	public:
  ...
  // Fields
  public:
    gui::Location::RunDensimOptions ^ RunDensimOptions;
  private:
    BindingSource ^ _locationBinding;
    int _mosDataStartYear;
    int _mosDataStopYear;
...
#pragma region Windows Form Designer generated code
      ...
      this->gboxYears->Location = System::Drawing::Point(12, 12);
      this->gboxYears->Name = L"gboxYears";
      this->gboxYears->Size = System::Drawing::Size(224, 119);
      this->gboxYears->TabIndex = 1;
      this->gboxYears->TabStop = false;
      this->gboxYears->Text = L"Simulation Year Range (from CIMSiM)";
      // 
      // radUseRange
      // 
      ...
      this->radUseRange->CheckedChanged += gcnew System::EventHandler(this, &RunDensimForm::OnRangeYearsChecked);
      // 
      // radUseAll
      // 
      ...
      this->radUseAll->CheckedChanged += gcnew System::EventHandler(this, &RunDensimForm::OnAllYearsChecked);
      // 
      // lblStopYear
      // 
      ...
      this->cboxStopYear->SelectionChangeCommitted += gcnew System::EventHandler(this, &RunDensimForm::OnStopYearChanged);
      // 
      // cboxStartYear
      // 
      ...
      this->cboxStartYear->SelectionChangeCommitted += gcnew System::EventHandler(this, &RunDensimForm::OnStartYearChanged);
      // 
      // btnRun
      // 
      ...
      this->btnRun->Location = System::Drawing::Point(12, 137);
      this->btnRun->Name = L"btnRun";
      this->btnRun->Size = System::Drawing::Size(75, 23);
      this->btnRun->TabIndex = 2;
      this->btnRun->Text = L"Run";
      this->btnRun->UseVisualStyleBackColor = true;
      this->btnRun->Click += gcnew System::EventHandler(this, &RunDensimForm::OnRun);
      // 
      // btnCancel
      // 
      this->btnCancel->DialogResult = System::Windows::Forms::DialogResult::Cancel;
      this->btnCancel->Location = System::Drawing::Point(161, 137);
      ...
      this->ClientSize = System::Drawing::Size(248, 172);
