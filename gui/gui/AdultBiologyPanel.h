...
namespace gui {
  ...
  private: System::Windows::Forms::Label^  lblFirstDevelopmentThreshold;
  ...
  private: ctrl::ScientificNotationTextBox^  snboxFirstDevelopmentThreshold;
...
#pragma region Windows Form Designer generated code
      ...
      this->lblFirstDevelopmentThreshold = (gcnew System::Windows::Forms::Label());
      ...
      this->snboxFirstDevelopmentThreshold = (gcnew ctrl::ScientificNotationTextBox());
      ...
      this->lblFecundityFactor->Location = System::Drawing::Point(9, 115);
      ...
      this->lblDryToWetWeightFactor->Location = System::Drawing::Point(9, 89);
      ...
      // 
      // lblFirstDevelopmentThreshold
      // 
      this->lblFirstDevelopmentThreshold->AutoSize = true;
      this->lblFirstDevelopmentThreshold->Location = System::Drawing::Point(9, 11);
      this->lblFirstDevelopmentThreshold->Name = L"lblFirstDevelopmentThreshold";
      this->lblFirstDevelopmentThreshold->Size = System::Drawing::Size(139, 13);
      this->lblFirstDevelopmentThreshold->TabIndex = 0;
      this->lblFirstDevelopmentThreshold->Text = L"First development threshold:";
      // 
      // lblSecondDevelopmentThreshold
      // 
      this->lblSecondDevelopmentThreshold->AutoSize = true;
      this->lblSecondDevelopmentThreshold->Location = System::Drawing::Point(9, 37);
      ...
      this->lblMinimumOvipositionTemperature->Location = System::Drawing::Point(9, 141);
      ...
      this->lblInterruptedFeedsPerMeal->Location = System::Drawing::Point(9, 167);
      ...
      this->gboxSatDef->Location = System::Drawing::Point(3, 501);
      ...
      this->gboxTemp->Location = System::Drawing::Point(3, 320);
      ...
      this->gboxDBM->Location = System::Drawing::Point(3, 630);
      ...
      // 
      // snboxFirstDevelopmentThreshold
      // 
      this->snboxFirstDevelopmentThreshold->Location = System::Drawing::Point(280, 11);
      this->snboxFirstDevelopmentThreshold->Name = L"snboxFirstDevelopmentThreshold";
      
      this->snboxFirstDevelopmentThreshold->Size = System::Drawing::Size(80, 20);
      this->snboxFirstDevelopmentThreshold->TabIndex = 1;
      this->snboxFirstDevelopmentThreshold->Text = L"0";
      this->snboxFirstDevelopmentThreshold->TextAlign = System::Windows::Forms::HorizontalAlignment::Right;
      
      
      // 
      // snboxSecondDevelopmentThreshold
      // 
      this->snboxSecondDevelopmentThreshold->Location = System::Drawing::Point(280, 37);
      ...
      // 
      this->snboxDryToWetWeightFactor->Location = System::Drawing::Point(280, 89);
      ...
      // 
      this->snboxMinimumOvipositionTemperature->Location = System::Drawing::Point(280, 141);
      ...
      // 
      this->snboxFecundityFactor->Location = System::Drawing::Point(280, 115);
      ...
      // 
      this->snboxInterruptedFeedsPerMeal->Location = System::Drawing::Point(280, 167);
      ...
      this->Controls->Add(this->snboxFirstDevelopmentThreshold);
      ...
      this->Controls->Add(this->lblFirstDevelopmentThreshold);
      this->Name = L"AdultBiologyPanel";
      this->Size = System::Drawing::Size(380, 757);
