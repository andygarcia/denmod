...
{
public:
  static Collections::Generic::List<OutputInfo^> ^ CimsimLocation;
  static Collections::Generic::List<OutputInfo^> ^ CimsimContainers;
  static Collections::Generic::List<OutputInfo^> ^ DensimLocation;
  static Collections::Generic::List<OutputInfo^> ^ DensimSerotypes;
...
public:
  ...
  public:
    enum class Location : int
    {
      ...
      [OutputInfoAttribute(Name="Human Population Size",Units="# of individuals")]
      PopulationSize,
