...
double
SimContainer::GetNewFemaleCount(void)
{
  return _newFemales;
}
...
double
SimContainer::GetEmergedPupaeAverageWeight(void)
{
  return _pupaeWeight;
}
...
double
SimContainer::GetUntreatedDensity(void)
{
...
double
SimContainer::GetTreatedDensity(void)
{
...
double
SimContainer::GetOvipositionPreference(void)
{
  return _ovipositionPreference;
}
